...
- `head.fontRevision` 使用 OpenType 16.16 fixed 数值 `1.0392` 对应本仓库语义版本 `1.0.39.2`；nameID 5 继续写作 `Version 1.0.39.2 ...`。

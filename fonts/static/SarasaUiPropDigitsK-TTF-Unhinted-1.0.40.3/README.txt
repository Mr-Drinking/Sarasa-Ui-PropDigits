...
破折号跟随 Source Han/Shanggu 的 ccmp、locl、vert/vrt2 结构。K
...
name 表包含地区本地化显示名，例如：
사라사 고딕 Ui PropDigits K ExtraLight.
...
覆盖和基础 lookup 结构按对应样式的上游 Sarasa Ui K 静态字体套模板；

Sarasa Ui PropDigits SC TTF Unhinted 1.0.40.3

本目录包含静态 TrueType 字体。这些字体从静态 SourceHanSansSC 和
Inter 源字体出发，经 Sarasa 的 pass1/kanji/hangul/pass2 构建路径生成，
然后补上 PropDigits 派生行为。

SC 地区沿用 Sarasa 上游路径：CJK 底稿来自 SourceHanSansSC。
...
破折号跟随 Source Han/Shanggu 的 ccmp、locl、vert/vrt2 结构。SC

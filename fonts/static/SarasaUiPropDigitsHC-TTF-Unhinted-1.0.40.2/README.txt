Sarasa Ui PropDigits HC TTF Unhinted 1.0.40.2

本目录包含静态 TrueType 字体。这些字体从静态 SourceHanSansHC 和
Inter 源字体出发，经 Sarasa 的 pass1/kanji/hangul/pass2 构建路径生成，
然后补上 PropDigits 派生行为。

HC 地区沿用 Sarasa 上游路径：CJK 底稿来自 SourceHanSansHC。
...
name 表包含地区本地化显示名，例如：
更紗黑體 Ui PropDigits HC ExtraLight.
